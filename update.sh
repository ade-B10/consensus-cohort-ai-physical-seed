...
#
# Usage:
#   1. Put the updated unencrypted file at source/Consensus_Cohort_AI_Physical_Seed.html
...
SOURCE_FILE="source/Consensus_Cohort_AI_Physical_Seed.html"
OUTPUT_FILE="index.html"
LABEL="Base10 · AI-Physical Seed Consensus Cohort"
INSTRUCTIONS="Enter the password to access Base10 · AI-Physical Seed Consensus Cohort."
REMEMBER_DAYS=14
...
if [ ! -f "$SOURCE_FILE" ]; then
  ...
  echo "  mkdir -p source"
  echo "  cp /Users/ade/Desktop/Urizen/Consensus_Cohort_AI_Physical_Seed.html source/"
  echo ""
  exit 1
fi
...
sed -i.bak "s|<title>Protected Page</title>|<title>Base10 · AI-Physical Seed Consensus Cohort</title>|" "$OUTPUT_FILE"
...
echo "  git commit -m \"Refresh Base10 · AI-Physical Seed Consensus Cohort ($(date +%Y-%m-%d))\""
echo "  git push"
echo ""
