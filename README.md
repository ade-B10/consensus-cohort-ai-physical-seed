# Base10 · AI-Physical Seed Consensus Cohort

AI-physical / defense / drone-manufacturing seed-stage consensus cohort + DNA + methodology. Internal Base10 reference.

**Live URL**: `https://ade-B10.github.io/consensus-cohort-ai-physical-seed/`
...
2. Enter the team password (saved in 1Password under "Base10 · AI-Physical Seed Consensus Cohort")
...
```bash
cd /Users/ade/Desktop/Urizen/consensus-cohort-ai-physical-seed-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Consensus_Cohort_AI_Physical_Seed.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · AI-Physical Seed Consensus Cohort ($(date +%Y-%m-%d))"
git push
```
