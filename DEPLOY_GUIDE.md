...
You're deploying to: `https://ade-B10.github.io/consensus-cohort-ai-physical-seed/`
Password (save in 1Password under "Base10 · AI-Physical Seed Consensus Cohort"): `Base10Automation!`
...
2. Repository name: `consensus-cohort-ai-physical-seed`
...
2. In Finder, open `/Users/ade/Desktop/Urizen/consensus-cohort-ai-physical-seed-deploy/`
...
`https://github.com/ade-B10/consensus-cohort-ai-physical-seed/settings/pages`
...
1. Under "Build and deployment":
   ...
   - **Branch**: `main` / `/ (root)`
2. Click **Save**
3. Wait ~30 seconds. The page will show: "Your site is live at `https://ade-B10.github.io/consensus-cohort-ai-physical-seed/`"
...
- Ask in Claude to "update Base10 · AI-Physical Seed Consensus Cohort with [the new info]"
- Claude will edit `source/Consensus_Cohort_AI_Physical_Seed.html`, run `./update.sh`, and tell you the exact commit message
- You just commit + push (or paste the new `index.html` into GitHub web UI)

**DIY path:**
1. Update `source/Consensus_Cohort_AI_Physical_Seed.html` directly (or have Claude do it)
2. In Terminal: `cd ~/Desktop/Urizen/consensus-cohort-ai-physical-seed-deploy && ./update.sh`
